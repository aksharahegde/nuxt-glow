  ...
  <section class="flex justify-center items-center w-full">
    <GlowCapture :size="500">
      <GlowElement color="#06B6D4">
        <div
          class="glow:ring-1 glow:border-glow glow:ring-glow glow:bg-glow/[.15] border-2 border-gray-700 rounded-2xl p-8"
        >
          <div class="flex items-start gap-6">
            ...
            <div class="flex-grow">
              ...
              <div>
                <h4 class="font-semibold text-gray-200 glow:text-glow">
                  John Doe
                </h4>
                <p class="text-sm text-gray-400 glow:text-glow/80">
                  CTO at Example Company
                </p>
              </div>
            </div>
          </div>
